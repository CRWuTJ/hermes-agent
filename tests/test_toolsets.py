...
class TestToolsetConsistency:
    ...
    def test_delegation_toolset_includes_claude_code_task(self):
        assert "claude_code_task" in resolve_toolset("delegation")
        assert "claude_code_task" in resolve_toolset("hermes-cli")
